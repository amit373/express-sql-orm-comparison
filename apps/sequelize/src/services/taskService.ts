...
export class TaskService implements ITaskService {
  ...
  private userRepository = new UserRepository(); // This needs to be implemented for Sequelize
  ...
  async updateTask(
    ...
    try {
      ...
      // For general update, maybe restrict fields? But interface says updateTask.
      // Let's assume USER can update if it's their task.
      if (userRole === UserRole.USER && task.assignedToId === userId) {
        return await this.taskRepository.update(taskId, taskData);
      }
